...
const ConsultationModal = ({ isOpen, onClose, title = "Получить консультацию" }) => {
  ...
  return (
    <div 
      className="fixed inset-0 h-screen bg-black bg-opacity-50 flex items-center justify-center z-50 px-4"
      onClick={handleBackdropClick}
    >
      <div className="bg-white rounded-lg h-screen max-w-md w-full p-6">
